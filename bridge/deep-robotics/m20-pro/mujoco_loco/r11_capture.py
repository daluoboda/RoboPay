...
Real MuJoCo physics for deep-robotics-m20-pro: unpaid still -> pay (202+action_id) ->
...
Produces: r11/deep-robotics-m20-pro_t1_uncut.gif (or .mp4)
"""
...
ROBOT_ID = "deep-robotics-m20-pro"
LEGS = ['lf', 'rf', 'lh', 'rh']
