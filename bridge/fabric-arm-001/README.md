# fabric-arm-001 — RoboPay Tier 1 bridge (Simulator Skill Execution)
...
| profileId | `fabric.fabric-arm-001.mujoco-sim.v1` |
...
```
 ...
 flow/zenoh_transport.py         publish  robot/tunnel/action
      ▼
 flow/node.py                    fabric-arm-001 robot node
      ▼
