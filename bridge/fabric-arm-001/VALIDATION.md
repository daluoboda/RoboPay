# Validation report — fabric-arm-001 (RoboPay Tier 1)
...
`pick_object`, 0.10 USDC (`100000` atomic units, 6 decimals) on Base Sepolia,
...
`robotId: fabric-arm-001`, `profileId: fabric.fabric-arm-001.mujoco-sim.v1`,
...
`.github/workflows/fabric-arm-001-bridge.yml`.
