"""End-to-end demo client for fetch-arm-001 (criterion #1, #10).
...
def run_once(relay: Relay, executor_probe, obj: str, verbose: bool = True,
    ...
    request = {"robotId": ROBOT_ID, "skill": "fetch_object",
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(description="fetch-arm-001 paid-flow demo")
    ...
    print("=" * 68)
    print(f" RoboPay Tier 1 demo -- {ROBOT_ID} / fetch_object")
