        ...
        try:
            ...
            with tempfile.TemporaryDirectory(prefix="fabric_payment_gate_") as temp_dir:
                ...
                unpaid_status, unpaid_headers, unpaid_body = http_post(
                    action_url, {"action": "fetch_object"}
                )
                ...
                # Prove the 402 challenge is wired for fetch-arm-001.
                required = json.loads(
                ...
                malformed_status, _, _ = http_post(
                    action_url, {"action": "fetch_object", "params": "not-an-object"}
                )
