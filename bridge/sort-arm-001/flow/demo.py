"""End-to-end demo client for sort-arm-001 (criterion #1, #10).
...
def run_once(relay: Relay, executor_probe, obj: str, verbose: bool = True,
    ...
    request = {"robotId": ROBOT_ID, "skill": "sort_object",
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(description="sort-arm-001 paid-flow demo")
    ...
    print("=" * 68)
    print(f" RoboPay Tier 1 demo -- {ROBOT_ID} / sort_object")
