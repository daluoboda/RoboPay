...
def main():
    ...
    d.text((40, 40), "RoboPay Tier 1 — unitree-g1-arm-001 (planar biped walker)",
    ...
    d.text((40, 130), "402 -> pay -> MuJoCo gait -> settle", font=_font(20),
           fill=(110, 200, 110))
    d.text((40, 170), "txHash: 0xcb9cab548125ddf34980bf14a5bbb57d8a86d9896348a46d63f9178f34470cc4",
