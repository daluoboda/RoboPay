...
tracked file.  The Tunnel, x402 client/facilitator, Zenoh transport, and CR3
...
def _tunnel_environment(
    *,
    ...
    return {
        ...
        "ROBO_PAY_PRICE": f"${PRICE_USDC}",
        "ROBO_PAY_NETWORK": NETWORK,
...
def main(argv: list[str] | None = None) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="robopay_dobot_cr3_base_sepolia_") as directory:
        temp = Path(directory)
        ...
        bridge = subprocess.Popen(
            [sys.executable, "-m", "dobot_cra_sim.bridge"],
