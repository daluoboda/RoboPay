...
from dobot_cra_sim.bridge import BridgeSettings, DobotCR3Execution, DobotCR3ZenohBridge, DurableReplayStore
...
def test_real_zenoh_bridge_runs_real_mujoco_once_then_rejects_replay(tmp_path: Path) -> None:
    ...
    bridge = DobotCR3ZenohBridge(
        BridgeSettings(endpoint, None, "robot/tunnel/action", "robot/tunnel/result", "robot/dobot_cra_cr3/metrics"),
        DobotCR3Execution(
