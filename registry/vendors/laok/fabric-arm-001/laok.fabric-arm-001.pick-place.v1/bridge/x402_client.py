"""x402 payment gate + optional live facilitator verify/settle for fabric-arm-001.
...
def build_requirements(payment: dict, payee: str) -> "PaymentRequirements":
    return PaymentRequirements(
        ...
        extra={
            "resource": "robopay://fabric-arm-001/pick_object",
            "description": "One physics-executed pick_object on fabric-arm-001.",
        },
    )
