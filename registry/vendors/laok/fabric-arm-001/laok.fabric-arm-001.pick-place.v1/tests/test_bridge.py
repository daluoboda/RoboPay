"""Behavioral tests for the laok fabric-arm-001 RoboPay bridge.
...
from laok_fabric_arm_zenoh_bridge import Bridge, params_hash  # noqa: E402
...
def test_skill_discoverable(bridge):
    ...
    assert sk["skillId"] == "fabric_arm_pick_place"
...
def test_unpaid_challenged(bridge):
    code, resp = bridge.request_action(
        {"actionId": "a", "robotId": ROBOT, "skillId": "fabric_arm_pick_place",
