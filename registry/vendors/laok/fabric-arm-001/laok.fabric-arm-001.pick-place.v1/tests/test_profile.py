"""Structural and privacy validation for the laok fabric-arm-001 profile."""
import os
...
PROFILE_ID = "laok.fabric-arm-001.pick-place.v1"
...
def test_robot_profile_fields():
    ...
    assert rp["robotModel"] == "fabric-arm-001"
...
def test_action_envelope_example():
    ...
    assert env["skillId"] == "fabric_arm_pick_place"
