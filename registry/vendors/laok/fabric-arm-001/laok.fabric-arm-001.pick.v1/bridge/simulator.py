"""fabric-arm-001 --- MuJoCo backend for the RoboPay Tier 1 skill bridge.
...
Public surface consumed by flow/executor.py:
    MuJoCoSimulator().pick_object(params) -> PickResult(success, reason, metrics)
"""
...
class MuJoCoSimulator:
    """One instance == one robot. `pick_object` rebuilds the cell per call so
