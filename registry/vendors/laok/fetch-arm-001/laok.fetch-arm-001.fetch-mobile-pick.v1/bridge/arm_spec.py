"""fetch-001 --- engine-independent robot spec and skill plan.
...
NOTE: link geometry is identical to stack-arm-001 (reused). The only semantic
difference for fetch-001 is the placement target: cube A is placed onto a
STATIC shelf (pick-and-place) instead of onto a second dynamic cube (stack).
"""
...
SCENES = {
    ...
    "unreachable": {"cube": (0.95, 0.0), "shelf": SHELF_POS, "obstacle": None, "budget": DEFAULT_BUDGET},
    "collision": {"cube": (0.35, 0.0), "shelf": SHELF_POS, "obstacle": (0.27, 0.0), "budget": DEFAULT_BUDGET},
    "timeout": {"cube": (0.35, 0.0), "shelf": SHELF_POS, "obstacle": None, "budget": 60},
}
ALIASES = {
