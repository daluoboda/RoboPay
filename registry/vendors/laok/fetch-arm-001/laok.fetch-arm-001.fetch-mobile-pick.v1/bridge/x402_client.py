"""x402 payment gate + optional live facilitator verify/settle for fetch-001.
...
def build_requirements(payment: dict, payee: str) -> "PaymentRequirements":
    return PaymentRequirements(
        ...
        extra={
            "resource": "robopay://fetch-001/fetch_mobile_pick",
            "description": "One physics-executed fetch_mobile_pick on fetch-001.",
        },
    )
