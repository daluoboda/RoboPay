"""Real Tunnel proof that failed / timed-out / replayed fetch-arm-001
...
SKILL_CATALOG = (
    ...
    / "registry/vendors/laok/fetch-arm-001/laok.fetch-arm-001.fetch-mobile-pick.v1"
    / "skill-catalog.json"
)
ACTION_TOPIC = "robot/tunnel/action"
RESULT_TOPIC = "robot/tunnel/result"
ROBOT_ID = "fetch_arm_001_nosettle"
ZENOH_TEST_PORT = int(os.environ.get("FETCH_NOSETTLE_ZENOH_PORT", "7447"))
...
class FetchNoSettlementTests(unittest.TestCase):
