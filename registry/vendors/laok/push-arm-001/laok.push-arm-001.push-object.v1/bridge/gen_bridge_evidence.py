"""Drive the laok push-arm-001 bridge to produce live async evidence.
...
from laok_push_arm_001_zenoh_bridge import Bridge, LoopbackTransport, params_hash
...
def main():
    ...
    print("=" * 70)
    print(" laok push-arm-001 — ASYNC PAY-TO-ACTUATE EVIDENCE (loopback transport)")
    print("=" * 70)

    print("\n[A] UNPAID REQUEST  ->  HTTP 402 + PAYMENT-REQUIRED")
    code, resp = bridge.request_action(
        {"actionId": "a1", "robotId": ROBOT, "skillId": "push_arm_push_object",
