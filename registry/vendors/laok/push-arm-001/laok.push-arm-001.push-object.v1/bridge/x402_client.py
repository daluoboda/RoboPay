"""x402 payment gate + optional live facilitator verify/settle for push-arm-001.
...
def build_requirements(payment: dict, payee: str) -> "PaymentRequirements":
    return PaymentRequirements(
        ...
        extra={
            "resource": "robopay://push-arm-001/push_object",
            "description": "One physics-executed push_object on push-arm-001.",
        },
    )
