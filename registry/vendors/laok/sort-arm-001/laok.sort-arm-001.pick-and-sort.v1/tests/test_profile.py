"""Structural and privacy validation for the laok sort-arm-001 profile."""
import os
...
PROFILE_ID = "laok.sort-arm-001.pick-and-sort.v1"
...
def test_robot_profile_fields():
    ...
    assert rp["robotModel"] == "sort-arm-001"
...
def test_action_envelope_example():
    import json
    env = json.load(open(os.path.join(PROFILE, "examples", "action-envelope.pick-and-sort.json")))
