"""Safe-stop / bounded-policy tests for sort-arm-001 — REAL MuJoCo.
...
The same simulator the paid flow uses (MuJoCoSimulator.pick_and_sort) is
...
class TestSafeStopReal:
    ...
    def test_timeout_stops_on_budget(self):
        ...
        sim = MuJoCoSimulator()
        result = sim.pick_and_sort({"object": "timeout"})
    ...
    def test_unreachable_stops_short(self):
        ...
        sim = MuJoCoSimulator()
        result = sim.pick_and_sort({"object": "unreachable"})
    ...
    def test_normal_scene_completes_within_budget(self):
        ...
        sim = MuJoCoSimulator()
        result = sim.pick_and_sort({"object": "cube"})
