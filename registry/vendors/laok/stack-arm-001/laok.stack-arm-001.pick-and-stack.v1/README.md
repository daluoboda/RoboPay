# laok × stack-arm-001 — Tier 1 simulated pick-and-place

A Tier 1 RoboPay integration: a **simulated 2-DOF arm (`stack-arm-001`)** that
...
```
laok.stack-arm-001.pick-and-stack.v1/
...
export ROBOT_ID=stack-arm-001-demo-001
