...
| # | Criterion | Evidence |
|---|----------|----------|
| 1 | Real 402 payment challenge | `docs/evidence/terminal/laok-fabric-arm-402.png`, `bridge/laok_stack_arm_001_zenoh_bridge.py` (`do_GET`/`do_POST` 402 path) |
...
| 4 | Simulator executes the skill | `docs/evidence/terminal/laok-fabric-arm-mujoco.png`, `bridge/simulator.py` (`MuJoCoSimulator.pick_and_stack`) |
| 5 | Object physically lifted | metrics: `objectLifted 0.1313 m`, `graspState attached` |
| 6 | Async action/result over Zenoh | `docs/evidence/terminal/laok-fabric-arm-async.png`, `bridge/laok_stack_arm_001_zenoh_bridge.py` (`ZenohTransport`) |
