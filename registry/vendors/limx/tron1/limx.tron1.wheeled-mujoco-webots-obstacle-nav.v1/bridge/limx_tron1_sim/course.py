...
OBSTACLES = (
    Obstacle("amber_gate", 1.2, 0.0, 0.18, 0.48, 0.62, (1.0, 0.48, 0.04, 1.0)),
    Obstacle("cyan_gate", 2.8, 0.0, 0.18, 0.48, 0.72, (0.05, 0.72, 0.88, 1.0)),
    Obstacle("violet_gate", 4.4, 0.0, 0.18, 0.48, 0.82, (0.58, 0.22, 0.86, 1.0)),
)
