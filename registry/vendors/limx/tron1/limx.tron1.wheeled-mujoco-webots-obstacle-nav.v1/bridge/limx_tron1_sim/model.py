...
VENDOR_ROOT = PROFILE_ROOT / "vendor" / "limxdynamics"
ROBOT_ROOT = VENDOR_ROOT / "robot-description" / "WF_TRON1A"
MUJOCO_XML = ROBOT_ROOT / "xml" / "robot.xml"
URDF = ROBOT_ROOT / "urdf" / "robot.urdf"
MESHES = ROBOT_ROOT / "meshes"
POLICY_ROOT = VENDOR_ROOT / "tron1-rl-deploy-python" / "WF_TRON1A"
POLICY_ONNX = POLICY_ROOT / "policy" / "isaacgym" / "policy.onnx"
ENCODER_ONNX = POLICY_ROOT / "policy" / "isaacgym" / "encoder.onnx"
