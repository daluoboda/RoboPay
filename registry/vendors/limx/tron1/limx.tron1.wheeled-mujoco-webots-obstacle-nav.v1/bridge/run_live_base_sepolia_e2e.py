...
from limx_tron1_sim.bridge import READY_TOPIC
from limx_tron1_sim.visual_proxy import LocalTunnelProxy
...
def main(argv: list[str] | None = None) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="robopay_limx_tron1_base_sepolia_") as directory:
        ...
        bridge = subprocess.Popen(
            [sys.executable, "-m", "limx_tron1_sim.bridge"],
