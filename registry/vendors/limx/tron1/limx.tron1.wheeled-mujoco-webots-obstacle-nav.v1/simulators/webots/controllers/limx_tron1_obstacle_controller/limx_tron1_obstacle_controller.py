"""Task-level Webots adapter for the official LimX WF_TRON1A.
...
from limx_tron1_sim.policy import JOINT_NAMES
...
MIN_SAFE_BASE_HEIGHT_M = 0.62
MAX_SAFE_TILT_RAD = 0.55
WHEEL_RADIUS_M = 0.130
WHEEL_INDICES = (3, 7)
...
def main() -> int:
    ...
    for index, motor in enumerate(motors):
        if motor is None:
            raise RuntimeError(f"official WF_TRON1A Webots model is missing {JOINT_NAMES[index]}")
