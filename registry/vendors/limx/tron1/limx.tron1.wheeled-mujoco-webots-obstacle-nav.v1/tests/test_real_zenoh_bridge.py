...
from limx_tron1_sim.bridge import BridgeSettings, DurableReplayStore, LimXTron1Execution, LimXTron1ZenohBridge
...
def test_real_zenoh_bridge_runs_real_mujoco_once_then_rejects_replay(tmp_path: Path) -> None:
    ...
    bridge = LimXTron1ZenohBridge(
        BridgeSettings(endpoint, None, "robot/tunnel/action", "robot/tunnel/result", "robot/limx_tron1/metrics"),
        LimXTron1Execution(
